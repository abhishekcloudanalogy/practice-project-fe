...
export const baseApi = createApi({
    ...
    tagTypes: ['Contact', 'Customer', 'Address', 'Pdfs', 'Partner', 'PartnerProgram', 'Form', 'ProgramForm', 'User', 'Opportunity', 'Quote', 'LineItem', 'QuoteDetail', 'QuoteFileLineItems', 'ProfitabilityItem', 'Meeting'],
    endpoints: () => ({}),
})
